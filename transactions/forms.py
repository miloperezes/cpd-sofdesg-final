...
class SupplierForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['comment'].widget.attrs.update({'class': 'textinput form-control'})
    class Meta:
        model = Supplier
        fields = ['name', 'phone', 'address', 'email', 'comment']
        widgets = {
            'comment': forms.Textarea(attrs={'class': 'textinput form-control', 'rows': '4'}),
