...
urlpatterns = [
    ...
    path('sales/export-csv/', views.export_sales_to_csv, name='export-sales-to-csv'),
    path('export-purchases-to-csv/', views.export_purchases_to_csv, name='export-purchases-to-csv'),
]